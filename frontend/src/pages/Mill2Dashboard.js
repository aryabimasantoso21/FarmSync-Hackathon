...
function Mill2Dashboard() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`${API_URL}/mill2/balance`);
    ...
    <div>
      ...
      <div className="dashboard">
        <div className="header">
          <h1>Mill 2 Payment Dashboard</h1>
        ...
        <div className="table-container">
          <h2>💸 Outgoing Payments from Mill 2</h2>
